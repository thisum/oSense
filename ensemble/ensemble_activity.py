...
def evaluate_algorithms(train_df, test_df, fold, name):
    ...
    conf_matx = ''
    activity_model = None
    model_name = "../data/ensemble/models/activity_" + name + "_" + str(fold) + ".pkl"
    for i in range(5):
...
def run_algorithm_per_person(fold):
    ...
    for name in names_list:
        ...
        evaluate_algorithms(train, test, fold, name)
