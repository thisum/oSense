...
def run_machine_learning(train_df, test_df, fold, name):
    ...
    conf_matx = ''
    posture_model = None
    model_name = "../data/ensemble/models/posture_" + name + "_" + str(fold) + ".pkl"
...
def evaluate_algorithms(fold):
    ...
    for name in names_list:
        ...
        run_machine_learning(train, test, fold, name)
