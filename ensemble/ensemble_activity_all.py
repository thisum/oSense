...
from category_file_processor_all import prepare_test_train_files
...
def evaluate_algorithms(train_df, test_df, name):
    ...
    conf_matx = ''
    activity_model = None
    model_name = "../data/ensemble/models/activity_" + name + ".pkl"
    for i in range(10):
...
def run_algorithm_per_person():
    ...
    for name in names_list:
        ...
        evaluate_algorithms(train, test, name)
